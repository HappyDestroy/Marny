...
public class MainActivity extends SherlockActivity {
	...
	private void fillBDD() {
		...
		ContentValues valuesHelmet0 = new ContentValues();
		// Ajout Helmet lvl 0
		valuesHelmet0.put(HelmetContract.COL_ID, 0);
		valuesHelmet0.put(HelmetContract.COL_HEALTHVALUE, 0);
		valuesHelmet0.put(HelmetContract.COL_ATTACKVALUE, 0);
		valuesHelmet0.put(HelmetContract.COL_ARMORVALUE, 0);
		valuesHelmet0.put(HelmetContract.COL_PRICE, 0);
		db.insert(HelmetContract.TABLE, null, valuesHelmet0);
		
		ContentValues valuesHelmet1 = new ContentValues();
		// Ajout Helmet lvl 1
		valuesHelmet1.put(HelmetContract.COL_ID, 1);
		...
		// Ajout Helmet lvl 2
		valuesHelmet2.put(HelmetContract.COL_ID, 2);
		...
		// Ajout Helmet lvl 3
		valuesHelmet3.put(HelmetContract.COL_ID, 3);
		...
		// Ajout Helmet lvl 4
		valuesHelmet4.put(HelmetContract.COL_ID, 4);
		...
		ContentValues valuesShield0 = new ContentValues();
		// Ajout shields lvl 0
		valuesShield0.put(ShieldContract.COL_ID, 0);
		valuesShield0.put(ShieldContract.COL_HEALTHVALUE, 0);
		valuesShield0.put(ShieldContract.COL_ATTACKVALUE, 0);
		valuesShield0.put(ShieldContract.COL_ARMORVALUE, 0);
		valuesShield0.put(ShieldContract.COL_PRICE, 0);
		db.insert(ShieldContract.TABLE, null, valuesShield0);
		
		ContentValues valuesShield1 = new ContentValues();
		// Ajout shields lvl 1
		valuesShield1.put(ShieldContract.COL_ID, 1);
		...
		// Ajout shields lvl 2
		valuesShield2.put(ShieldContract.COL_ID, 2);
		...
		// Ajout shields lvl 3
		valuesShield3.put(ShieldContract.COL_ID, 3);
		...
		// Ajout shields lvl 4
		valuesShield4.put(ShieldContract.COL_ID, 4);
		...
		ContentValues valuesWeapon0 = new ContentValues();
		// v weapon lvl 0
		valuesWeapon0.put(WeaponContract.COL_ID, 0);
		valuesWeapon0.put(WeaponContract.COL_HEALTHVALUE, 0);
		valuesWeapon0.put(WeaponContract.COL_ATTACKVALUE, 0);
		valuesWeapon0.put(WeaponContract.COL_ARMORVALUE, 0);
		valuesWeapon0.put(WeaponContract.COL_PRICE, 0);
		db.insert(WeaponContract.TABLE, null, valuesWeapon0);
		
		ContentValues valuesWeapon1 = new ContentValues();
		// Ajout weapon lvl 1
		valuesWeapon1.put(WeaponContract.COL_ID, 1);
		...
		// Ajout weapon lvl 2
		valuesWeapon2.put(WeaponContract.COL_ID, 2);
		...
		// Ajout weapon lvl 3
		valuesWeapon3.put(WeaponContract.COL_ID, 0);
		...
		// Ajout weapon lvl 4
		valuesWeapon4.put(WeaponContract.COL_ID, 0);
